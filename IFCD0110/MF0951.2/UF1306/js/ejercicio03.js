...
function f1() {
    ...
    if (e.target.id == "Img1") {
        ...
        console.log(imagen);
        document.body.innerHTML += "<div id='Div1' style='z-index: 50'><form id='Form1'><input type='radio' name='gender' value='male'> Male<br><input type='radio' name='gender' value='female'> Female<br><input type='radio' name='gender' value='other'> Other<br>  <input type='submit' value='Submit'></form></div>";
    }
    if (e.target.id == "Form1") {
        if(female.checked==true){
            pass.type="text";
            console.log("marcado");  /* Seguir por aquí */
...
function f3() {
    console.log("Función f3:");
};

function experimental() {
    console.log("Función f1:");
    document.body.innerHTML += "<div id='Div1'><form id='Form1' action='/action_page.php'><input type='radio' name='gender' value='male'> Male<br><input type='radio' name='gender' value='female'> Female<br><input type='radio' name='gender' value='other'> Other<br>  <input type='submit' value='Submit'></form></div>";
    console.log("Genero.");
    document.body.innerHTML += "<figure id='Fig1'><img id='Img1' src='../img/img_avatar.png'></img></figure>";
...
/* <input type="checkbox" id="recuerdo" onClick="recordar()">Recordarme 
<input type="checkbox" id="boton_chequeo" onClick="ver()">Ver contraseña */

/* function recordar(){
var recuerdo = document.getElementById("recuerdo");
var divvpin = document.getElementById("divvpin");
if(recuerdo.cheked==false){
    console.log("no marcado");
    divvpin.style.display="none";
}else
    console.log("marcado");
    divvpin.style.display="block";
}

function ver(){
var boton_chequeo = document.getElementById("boton_chequeo");
var pass = document.getElementById("pass");
if(boton_chequeo.checked==true){
    pass.type="text";
    console.log("marcado");
}else
    pass.type="password";
